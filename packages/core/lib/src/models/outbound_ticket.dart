...
class OutboundTicket extends Equatable {
  ...
  factory OutboundTicket.fromMap(Map<String, dynamic> m) => OutboundTicket(
        id: m['id'] as int?,
  ...
  List<Object?> get props =>
      [id, ticketNumber, locationId, customerId, productId, status, synced];
}
